...
import {
  Brain, MessageSquare, BarChart3, FolderKanban,
  BookOpen, ImageIcon, ArrowRight,
} from "lucide-react";
...
const features = [
  {
    ...
    desc: "Upload your screenplay and get instant AI feedback — emotional arc, originality score, pacing analysis, and predicted audience impact.",
    accent: "#EC4899",
    glow: "rgba(236,72,153,0.12)",
    tag: "Analyse",
    href: "/analyse",
    cta: "Analyse a Script",
  },
  {
    icon: MessageSquare,
    title: "AI Dialogue Generator",
    desc: "Generate authentic dialogues for any scene in seconds. Choose tone, language (Hindi, Hinglish, English, or more), and character voice.",
    accent: "#22C55E",
    glow: "rgba(34,197,94,0.12)",
    tag: "Generate",
    href: "/dialogue",
    cta: "Generate Dialogue",
  },
  {
    icon: BookOpen,
    title: "Story Creator",
    desc: "Go from concept to a full story outline in minutes. AI-assisted narrative structure with genre, theme, and character arc suggestions.",
    accent: "#7C3AED",
  ...
  },
  {
    ...
    desc: "Model your film's budget, predict box office and OTT revenue, calculate ROI, IRR, and break-even — all with a single report.",
    accent: "#F59E0B",
    glow: "rgba(245,158,11,0.12)",
    tag: "Finance",
    href: "/financial",
    cta: "Open Finance Studio",
  },
  {
    icon: ImageIcon,
    title: "Scene Visualizer",
    desc: "Transform your scene descriptions into cinematic visuals. Generate mood boards, stills, and promotional concepts powered by AI.",
    accent: "#06B6D4",
    glow: "rgba(6,182,212,0.12)",
    tag: "Create",
    href: "/visualize",
    cta: "Visualize a Scene",
  },
  {
    icon: FolderKanban,
    title: "Project Management",
    desc: "Organise every script, draft, and collaborator in one place. Manage your entire film pipeline from development to post-production.",
    accent: "#3B82F6",
        ...
        >
          {features.map((f) => (
            ...
            >
              <Link
                href={f.href}
                className="block relative rounded-2xl p-6 h-full"
                style={{
